<template>
  ...
  <div class="staff pages">
    ...
    >
      <el-table-column prop="question" label="内容" width="auto"></el-table-column>
    ...
    <el-table
      ...
      v-else
    >
      <el-table-column prop="englishQuestion" label="englishQuestion" width="auto"></el-table-column>
      ...
      <el-table-column label="operation" width="300">
        <template slot-scope="scope">
          <el-button @click="redactAction(scope.$index)" size="mini" type="danger" class="el-btn">edit</el-button>
...
export default {
  ...
  methods: {
    ...
    redactAction(index) {
      this.$router.push({ name: "redactBrand", params: this.IssueList[index] });
    },
    removeAction(index) {
    ...
    commonAction() {
      ...
      request
        .post("/creaAssessIssue/selectIssueList", data)
        .then(res => {
